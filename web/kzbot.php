...
foreach ($json_object->events as $event) {
    ...
    $redis = new Predis\Client(getenv('redis://h:p97700738c27e78c8d2a0714a8e07a3fdb66323ba00cdac03d788cfd79028f88c@ec2-54-83-192-24.compute-1.amazonaws.com:12159'));
